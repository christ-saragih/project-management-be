...
type BoardRepository interface {
	...
	FindAllByUserPaginated(userPublicID, filter, sort string, limit, offset int) ([]models.Board, int64, error)
}
...
func (r *boardRepository) FindAllByUserPaginated(userPublicID, filter, sort string, limit, offset int) ([]models.Board, int64, error) {
